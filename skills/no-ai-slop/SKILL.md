---
name: no-ai-slop
description: Edit drafts into sharper human writing while preserving the writer's voice, or detect named AI-slop patterns without rewriting. Use when prose should be clearer, more direct, more specific, or less AI-sounding, or when the user asks for an AI-slop audit.
---

> Adapted from [the upstream no-ai-slop skill](https://github.com/petergyang/no-ai-slop/blob/d30eddb9e04562234f2070b5ee63ca4649d9a05e/skills/no-ai-slop/SKILL.md) at [the pinned commit](https://github.com/petergyang/no-ai-slop/commit/d30eddb9e04562234f2070b5ee63ca4649d9a05e).

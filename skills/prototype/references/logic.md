> Adapted from [the upstream reference](https://github.com/mattpocock/skills/blob/84fdeffd12f2ee307994d1eb6feb48173b6e0502/skills/engineering/prototype/LOGIC.md).
...
If the question is "what should this look like" — wrong branch. Use [the UI prototype guide](ui.md).
